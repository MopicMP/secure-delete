...
> Securely delete files (overwrite + remove)

[![PyPI version](https://badge.fury.io/py/secure-delete.svg)](https://pypi.org/project/secure-delete/)
...
result = delete("Hello World")

# Example 2: Batch processing
from secure_delete import batch
